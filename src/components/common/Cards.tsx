  ...
  return (
    ...
    >
      <div className="relative pb-4">
        ...
        {badgePosition === "top" ? (
          <span className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-secondary border-2 border-white text-white text-xs font-semibold px-2 py-1 rounded-full z-30">
            {badgeText}
          </span>
        ) : (
